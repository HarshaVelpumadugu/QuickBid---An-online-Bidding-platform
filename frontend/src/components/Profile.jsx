        ...
        <div className="overflow-hidden bg-gray-800 rounded-lg shadow-xl">
          <div className="p-6 sm:p-10">
            ...
            <div className="flex items-center justify-between mt-6">
              <button
                onClick={() =>
                  handlePageChange(currentPageAuctions - 1, "auctions")
                }
              ...
              <button
                ...
                className={`bg-indigo-600 text-white p-2 rounded-lg hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 ${
                  currentPageAuctions === totalPagesAuctions ||
            ...
            <div className="mt-12">
              ...
              <div className="flex items-center justify-between mt-6">
                <button
                  ...
                  className={`bg-indigo-600 text-white p-2 rounded-lg hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 ${
                    currentPageBids === 1 ? "cursor-not-allowed opacity-50" : ""
                  }`}
                ...
                <button
                  onClick={() => handlePageChange(currentPageBids + 1, "bids")}
                  className={`bg-indigo-600 text-white p-2 rounded-lg hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 ${
                    currentPageBids === totalPagesBids || totalPagesBids === 0
                      ? "cursor-not-allowed opacity-50"
                      : ""
                  }`}
                  disabled={
            ...
            <div className="mt-12">
              ...
              {paginatedWon.length ? (
                ...
                <p className="text-2xl text-gray-400 animate-bounce">
                  No wins yet,but your moment of victory is just around the
                  corner!
                </p>
              )}
              ...
              <div className="flex items-center justify-between mt-6">
                <button
                  ...
                  className={`bg-indigo-600 text-white p-2 rounded-lg hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 ${
                    currentPageWon === 1 ? "cursor-not-allowed opacity-50" : ""
                  }`}
                ...
                <button
                  onClick={() => handlePageChange(currentPageWon + 1, "won")}
                  className={`bg-indigo-600 text-white p-2 rounded-lg hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 ${
                    currentPageWon === totalPagesWon || totalPagesWon === 0
                      ? "cursor-not-allowed opacity-50"
                      : ""
                  }`}
                  disabled={
