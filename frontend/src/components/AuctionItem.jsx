      ...
      >
        ...
        {isAuctionEnded && winner && (
          <div className="p-4 mt-6 font-bold text-center text-black bg-yellow-500 rounded-lg">
            <h3 className="text-2xl">Congratulations {winner.username}!</h3>
            <p className="text-xl">You are the winner of this auction!</p>
          </div>
        )}
        {isAuctionEnded && !winner && (
          <div className="p-4 mt-6 font-bold text-center text-black bg-yellow-500 rounded-lg">
      ...
      {loadingBids ? (
        ...
        <div className="mb-6">
          {paginatedBids.map((bid) => {
            return (
              <div key={bid._id} className="p-4 mb-4 bg-gray-700 rounded-lg">
                <p className="text-lg">
